...
window.ChoreographyRoutine = (function() {
    ...
    $.ajax({
      ...
      success: (function(_this) {
        return function(data) {
          return _this.loadFirstRoutine(data);
        };
      })(this)
    });
  ...
  ChoreographyRoutine.prototype.loadFirstRoutine = function(firstRoutine) {
    this.reset();
    this.routine = JSON.parse(firstRoutine.data);
    this.updateText();
...
},{"./Config.coffee":3}],3:[function(require,module,exports){
...
},{"../javascript/OrbitControls":19,"./DatGUIInterface.coffee":4,"./Viewer.coffee":8,"./Visualizer.coffee":9}],6:[function(require,module,exports){
...
},{"./AudioWindow.coffee":1}],7:[function(require,module,exports){
...
},{"../javascript/Queue.js":20,"./ShaderLoader.coffee":7}],9:[function(require,module,exports){
